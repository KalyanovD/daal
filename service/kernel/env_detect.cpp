...
DAAL_EXPORT daal::services::Environment::Environment() : _controller(0)
{
...
DAAL_EXPORT daal::services::Environment::~Environment()
{
    ...
    _daal_tbb_global_control_free(_controller);
}
...
{
    isInit = true;
    daal::setNumberOfThreads(numThreads, &_controller);
}
